            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                    ...
                    <div className='mt-3 grid grid-cols-12 items-center px-2 justify-between'>
                        ...
                        <input className="input input-bordered rounded-3xl w-full block col-span-10 lg:col-span-11" placeholder="Write a comment..."
                            {...register("comment", { required: true })} />
                    </div>

                    <div className=' flex justify-end mt-2 mr-5'><button
                        type="submit" className='btn btn-xs bg-blue-600 text-white font-semibold border-0 text-xs rounded hover:bg-blue-700' >Comment</button></div>
                </form>
            </div>
