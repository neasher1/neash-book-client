    ...
    return (
        <div className='h-[500px] flex justify-center items-center my-32'>
            <div className='w-96 card shadow-2xl p-8'>
                <h2 className="text-4xl font-bold text-primary mb-4 text-center">Register</h2>
                <form onSubmit={handleSubmit(handleSignUp)}>
                    ...
                    <input className='btn btn-primary w-full text-white my-4' type="submit" value="Register" />
                </form>
